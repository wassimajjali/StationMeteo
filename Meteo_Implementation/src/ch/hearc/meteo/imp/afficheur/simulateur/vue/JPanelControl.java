...
public class JPanelControl extends JPanel
	...
	private void geometry()
		{
		boutonStart = new JButton("Start Meteo Station");
		boutonStop = new JButton("Stop Meteo Station");
		boutonPause = new JToggleButton("Pause Meteo Station");

		boutonStop.setBackground(Color.RED);
		boutonStop.setOpaque(true);

		boutonStart.setBackground(Color.GREEN);
		boutonStart.setOpaque(true);

		boutonPause.setBackground(Color.GREEN);
		boutonPause.setOpaque(true);
